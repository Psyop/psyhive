...
from psyhive import tk2, qt, pipe
...
class BCRoot(tk2.TTRoot):
    ...
    def find_step_roots(self, class_=None, filter_=None):
        ...
        """
        return super(BCRoot, self).find_step_roots(
    ...
    def read_work_files(self, force=False):
        ...
        for _step in self.find_step_roots():
            _work_area = _step.get_work_area(dcc='maya')
            _task_work_files = {}
            for _work_file in _work_area.find_work():
...
class BCOutputVersion(tk2.TTOutputVersion, Cacheable):
    ...
    def is_latest(self):
        ...
        Returns:
            (bool): whether latest
        """
        return super(BCOutputVersion, self).is_latest()


class BCWork(tk2.TTWork, Cacheable):
    ...
    def get_cacheable_assets(self):
        ...
        Returns:
            (BCOutputVersion list): list of assets
        """
