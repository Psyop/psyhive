...
_RELOAD_ORDER = [
    ...
    'psyhive.icons.set_',
    'psyhive.icons',
    'psyhive.qt.wrapper.qtw_mgr',
    'psyhive.qt.wrapper.qtw_gui.qtw_painter',
    'psyhive.qt.wrapper.qtw_gui.qtw_pixmap',
    'psyhive.qt.wrapper.qtw_gui',
    'psyhive.qt.wrapper.qtw_widgets',
    'psyhive.qt.wrapper',
    'psyhive.qt.misc',
    'psyhive.qt.msg_box',
